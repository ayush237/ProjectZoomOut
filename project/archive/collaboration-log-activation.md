# Collaboration log — archived 2026-09-25: INTRO-1, VO-3, PILOT-1, COVER-1, ONBOARD-1 and ONBOARD-2

**Moved out of `project/collaboration-log.md` at ONBOARD-2.1's sign-off**, with no session mid-package and every PR merged. The intro, the player, the pilot build, the two covers and the first-run flow up to its narrator clips. **Nothing here was edited except one restored header:** COVER-1's completion report had been appended without its `### Completed:` header — the failure the log's preamble warns about — and sat, unlabelled, at the end of ONBOARD-1's. Its header is restored below and marked. Entries keep the order they had, newest first: handoffs, then completions.
...
<!-- Header restored 2026-09-25 at the archive pass: this report was appended without one and sat, unlabelled, at the end of ONBOARD-1's. -->
