...
| WP3 | Content API — Explore, Library, Track/Leaf delivery | Manager | 🔵 **Released 2026-08-08** | Founder must fix the gate content first — see below |
...
| WP6 | Mobile shell — navigation, auth screens, age gate, design system | Manager | 🔒 | **Design direction approval only** — Xcode done, simulator check folded into WP2.1 |
