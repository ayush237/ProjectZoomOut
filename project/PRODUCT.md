...
**Slides 1, 2, 3 and 5 include a voiceover button** — Summary, Scenario, Payoff, Takeaway. **Confirmed 2026-08-06:** "human voice over" in the original brief means AI-generated audio in a natural human-sounding voice, not literally human-recorded narration. **Scope widened from slides 2–3 to four slides by the founder on 2026-09-17.** **Two narrators, and the reader chooses** — a female and a male voice (Google's Achernar and Sadaltager), ruled by the founder by ear during VO-2 after a six-voice audition. This replaced an earlier ruling the same day for a single voice. Sticky Notes is excluded: it is a recap of short fragments, not prose.
