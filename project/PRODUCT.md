...
**Slides 1, 2, 3 and 5 include a voiceover button** — Summary, Scenario, Payoff, Takeaway. **Confirmed 2026-08-06:** "human voice over" in the original brief means AI-generated audio in a natural human-sounding voice, not literally human-recorded narration. **Scope widened from slides 2–3 to four slides by the founder on 2026-09-17.** **Two narrators, and the reader chooses** — **Lara (female) and Druv (male)**, cast from Google's Achernar and Sadaltager voices, ruled by the founder by ear during VO-2 after a six-voice audition. This replaced an earlier ruling the same day for a single voice. **The names Lara and Druv were ruled 2026-09-24**, after the first onboarding greetings said the provider's voice ids aloud; **Achernar and Sadaltager are the provider's names for the voices and are never spoken or shown to a reader.** Sticky Notes is excluded: it is a recap of short fragments, not prose.
...
Phase 1 deliberately does not require the AI pipeline or social features to be *built*. The app is developed against placeholder content seeded through the CMS.

**Amended 2026-08-08:** launch content will be **generated by the Phase 2 pipeline**, not hand-authored — but the pipeline is built only **after all Phase 1 app and admin work is complete**, and gets its own brainstorming and design cycle. The entire app is built and verified against placeholder content. Consequence: vendor DPAs and IP counsel review of actual generated content move from post-launch to pre-launch, and Critic-in-the-Loop becomes the operative control on fabrication rather than a described process.
